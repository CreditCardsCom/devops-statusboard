defmodule Dashboard.Web do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: Dashboard.Web
      import Plug.Conn
      import Dashboard.Web.Router.Helpers
      import Dashboard.Web.Gettext
    end
  end

  def view do
    quote do
      use Phoenix.View, root: "lib/dashboard/web/templates",
      ...
      import Dashboard.Web.Router.Helpers
      import Dashboard.Web.ErrorHelpers
      import Dashboard.Web.Gettext
    end
  end
